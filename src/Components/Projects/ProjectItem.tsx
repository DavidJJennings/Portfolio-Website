...
const ProjectItem: React.FC<Props> = ({ project }) => {
  ...
  return (
    <motion.section
      ref={ref}
      key={project.id}
      className="overflow-hidden box-border h-screen w-screen snap-center pt-14 pb-8 px-12 flex flex-col justify-start items-center gap-y-4 lg:flex-row-reverse xl:px-20"
    >
